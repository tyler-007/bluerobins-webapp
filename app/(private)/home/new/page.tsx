  ...
  return (
    <div className="flex flex-row flex-1">
      <div className="flex flex-1 flex-col gap-2 p-5 overflow-y-auto">
        ...
        {isMentor ? (
          <div className="mt-7">
            <div className="bg-gradient-to-r from-green-500 to-blue-600 rounded-lg p-8 text-center text-white">
              <h2 className="text-3xl font-bold mb-4">Manage Your Projects</h2>
              ...
              <div className="flex gap-4 justify-center">
                ...
                <Link href="/project-hub">
                  <Button size="lg" variant="secondary" className="bg-white/20 border border-white text-white hover:bg-white hover:text-green-600">
                    View All Projects
                  </Button>
                </Link>
              </div>
